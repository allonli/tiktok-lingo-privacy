...
TikTok Lingo's use and transfer of received data comply with the Chrome Web Store User Data Policy, including its Limited Use requirements. Data is used only for user-visible subtitle and comment translation features, not for advertising, profiling, credit decisions or sale.
...
TikTok Lingo 对接收数据的使用和转移遵守 Chrome Web Store User Data Policy，包括 Limited Use 要求。数据仅用于用户可见的字幕及评论翻译，不用于广告、画像、信用评估或出售。
...
TikTok Lingo 對接收資料的使用與移轉遵守 Chrome Web Store User Data Policy，包括 Limited Use 要求。資料僅用於使用者可見的字幕與留言翻譯，不用於廣告、建立個人剖析、信用評估或出售。
